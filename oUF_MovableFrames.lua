...
do
	...
	function frame:VARIABLES_LOADED()
      ...
      _DB = oUFMFpos or {}
      if fuiDB and fuiDB["UnitFrames"]["raid"] then
         fuiDB["UnitFrames"].ResetFrames = "functionRESETUF()"
         fuiDB["UnitFrames"].MoveFrames = "functionSTARTMOVEFRAMES()"
      end
...
SlashCmdList['OUF_MOVABLEFRAMES'] = STARTMOVEFRAMES
