...
module.Init = function()
   ...
   local buttonsize = settings[module.name].ButtonSize or 27
   local flyoutsize = settings[module.name].FlyoutSize or 24
   local buttonspacing = settings[module.name].ButtonSpacing or 3
   local borderspacing = settings[module.name].BorderSpacing or 2
   ...
   local function SkinButton(button,colorr, colorg, colorb)
      SetTemplate(button)
      --SetTemplate(button.actionButton)
