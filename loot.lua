...
module.Init = function()
	...
	local iconSize = opts["Icon size"] or 28
	local frameScale = opts["Loot frame scale"] or 1
	...
	local createSlot = function(id)
		...
		count:SetFont(settings["Main"].Font, 12, "OUTLINE")
		...
		name:SetFont(settings["Main"].Font, 13, "OUTLINE")
	...
	title:SetFont(settings["Main"].Font, 13, "OUTLINE")
